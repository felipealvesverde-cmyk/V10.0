...
function adaptRuleForEngine(dbRow, visitor) {
  return {
    ...
    fromEntity: visitor.entity_type,
    ...
    // V35.0.0 — Trigger pode mover pra sub-stage específico (depois do estágio macro).
    toSubstageId: dbRow.to_substage_id ? Number(dbRow.to_substage_id) : null,
    capturesIdentity: true,
