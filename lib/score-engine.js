...
async function computeCriteriaScore(db, userId, visitor, signals) {
  ...
  // HubSpot puro: pontos diretos. Sem normalização, sem clamp.
  // Caller decide se persiste em global_score INT (pontos brutos cabem 0..2bi).
  return { score: totalPoints, totalPoints, hits, breakdown, byCategory };
}
