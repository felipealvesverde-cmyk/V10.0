...
const PRODUCTS = [
  { hotmartId: 'demo_pilsen',       ljId: 1781869701831, name: 'Cerveja Pilsen 600ml',  priceBRL: 22, share: 0.55 },
  { hotmartId: 'demo_weiss',        ljId: 5001,          name: 'Cerveja Weiss 500ml',   priceBRL: 28, share: 0.30 },
  { hotmartId: 'demo_chopp_vinho',  ljId: 5002,          name: 'Chopp de Vinho 250ml',  priceBRL: 72, share: 0.15 }
];

// Volume mensal online dos 3 produtos.
const TOTAL_APPROVED = 4230;
const TOTAL_CANCELED = 150;
const TOTAL_REFUNDED = 80;
const TOTAL_CHARGEBACK = 30;
const TOTAL_BILLET = 250;
...
module.exports = { buildDemoCheckoutMock };
