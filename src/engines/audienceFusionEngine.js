...
var AudienceFusionEngine = {
  ...
  NUCLEO_COMUM: [
    ...
    { key: 'comportamento_compra',layer: 'bp',  type: 'completude', label: 'Comportamento de compra', inferenciaRd: 'tags de intenção / oportunidades em stage avançado', criterio: null,                                                          tooltip: 'Sinal de intenção real (carrinho, demo agendada, proposta).' },
