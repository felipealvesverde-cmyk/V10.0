var JourneyPipelineModule = {
  defaultStages() {
    // V31.2.61 — 3 seções iguais, bolinhas evenly DENTRO de cada seção.
    //   Marketing: x=60 (TOF, início), 243 (MOF), 427 (BOF, fim da seção)
    //   Vendas:    x=467 (TOF), 650 (MOF), 833 (BOF)
    //   CS:        x=873 (TOF), 1057 (MOF), 1240 (BOF, fim da linha)
    // Tracejados Marketing|Vendas em x=447, Vendas|CS em x=853 (centro do gap).
    // Container min-w-[1300px]. TOF Mkt em x=60 (size 96) extends de x=12 a x=108
    // — não corta mais.
    return [
  ...
  visualVersion: 'revenue-flow-v4-sections',
  ...
  map() {
    ...
    return `<div class="relative h-[560px] lg:h-[360px] overflow-x-auto overflow-y-hidden"><div class="relative min-w-[1300px] h-full"><svg class="jp-pipeline-line" viewBox="0 0 1300 320" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="pipelineGradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#0f172a" /><stop offset="18%" stop-color="#2563eb" /><stop offset="36%" stop-color="#f59e0b" /><stop offset="54%" stop-color="#ef4444" /><stop offset="72%" stop-color="#10b981" /><stop offset="100%" stop-color="#6d28d9" /></linearGradient></defs><path class="jp-pipeline-path" d="M 60 90 L 243 160 L 427 230 Q 447 240 467 230 L 650 160 L 833 90 Q 853 80 873 90 L 1057 160 L 1240 230" /><path class="jp-pipeline-scan" d="M 60 90 L 243 160 L 427 230 Q 447 240 467 230 L 650 160 L 833 90 Q 853 80 873 90 L 1057 160 L 1240 230" /></svg><div class="absolute top-4 bottom-4 border-l-2 border-dashed border-slate-400" style="left: 447px; z-index: 1;"></div><div class="absolute top-4 bottom-4 border-l-2 border-dashed border-slate-400" style="left: 853px; z-index: 1;"></div><div class="jp-sector-label" style="left:203px; top:28px;">Marketing</div><div class="jp-sector-label" style="left:610px; top:28px;">Vendas</div><div class="jp-sector-label" style="left:1016px; top:28px;">CS</div><div class="jp-particle"></div><div class="jp-particle p2"></div><div class="jp-particle p3"></div><div class="jp-particle p4"></div><div class="jp-particle p5"></div><div class="absolute inset-0 z-10">${this.nodes()}</div></div></div>`;
  },
