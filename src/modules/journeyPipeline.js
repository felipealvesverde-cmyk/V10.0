var JourneyPipelineModule = {
  ...
  visualVersion: 'revenue-flow-v5-balanced',
  ...
  map() {
    ...
    return `<div class="relative h-[560px] lg:h-[360px] overflow-x-auto overflow-y-hidden"><div class="relative min-w-[1300px] h-full"><svg class="jp-pipeline-line" viewBox="0 0 1300 320" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="pipelineGradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#0f172a" /><stop offset="18%" stop-color="#2563eb" /><stop offset="36%" stop-color="#f59e0b" /><stop offset="54%" stop-color="#ef4444" /><stop offset="72%" stop-color="#10b981" /><stop offset="100%" stop-color="#6d28d9" /></linearGradient></defs><path class="jp-pipeline-path" d="M 70 90 L 210 160 L 350 230 Q 430 245 510 230 L 650 160 L 790 90 Q 870 75 950 90 L 1090 160 L 1230 230" /><path class="jp-pipeline-scan" d="M 70 90 L 210 160 L 350 230 Q 430 245 510 230 L 650 160 L 790 90 Q 870 75 950 90 L 1090 160 L 1230 230" /></svg><div class="absolute top-4 bottom-4 border-l-2 border-dashed border-slate-400" style="left: 430px; z-index: 1;"></div><div class="absolute top-4 bottom-4 border-l-2 border-dashed border-slate-400" style="left: 870px; z-index: 1;"></div><div class="jp-sector-label" style="left:170px; top:28px;">Marketing</div><div class="jp-sector-label" style="left:610px; top:28px;">Vendas</div><div class="jp-sector-label" style="left:1050px; top:28px;">CS</div><div class="jp-particle"></div><div class="jp-particle p2"></div><div class="jp-particle p3"></div><div class="jp-particle p4"></div><div class="jp-particle p5"></div><div class="absolute inset-0 z-10">${this.nodes()}</div></div></div>`;
  },
