var JourneyPipelineModule = {
  ...
  visualVersion: 'revenue-flow-v3-uniform',
  ...
  map() {
    ...
    // Linhas tracejadas verticais separam Marketing/Vendas/CS (no meio do gap entre áreas).
    return `<div class="relative h-[560px] lg:h-[360px] overflow-x-auto overflow-y-hidden"><div class="relative min-w-[1300px] h-full"><svg class="jp-pipeline-line" viewBox="0 0 1300 320" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="pipelineGradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#0f172a" /><stop offset="18%" stop-color="#2563eb" /><stop offset="36%" stop-color="#f59e0b" /><stop offset="54%" stop-color="#ef4444" /><stop offset="72%" stop-color="#10b981" /><stop offset="100%" stop-color="#6d28d9" /></linearGradient></defs><path class="jp-pipeline-path" d="M 40 90 L 192 160 L 345 230 Q 421 245 497 230 L 650 160 L 802 90 Q 878 70 955 90 L 1107 160 L 1260 230" /><path class="jp-pipeline-scan" d="M 40 90 L 192 160 L 345 230 Q 421 245 497 230 L 650 160 L 802 90 Q 878 70 955 90 L 1107 160 L 1260 230" /><line x1="421" y1="0" x2="421" y2="320" stroke="rgba(255,255,255,0.18)" stroke-width="1.5" stroke-dasharray="6,6" /><line x1="878" y1="0" x2="878" y2="320" stroke="rgba(255,255,255,0.18)" stroke-width="1.5" stroke-dasharray="6,6" /></svg><div class="jp-sector-label" style="left:155px; top:28px;">Marketing</div><div class="jp-sector-label" style="left:620px; top:28px;">Vendas</div><div class="jp-sector-label" style="left:1080px; top:28px;">CS</div><div class="jp-particle"></div><div class="jp-particle p2"></div><div class="jp-particle p3"></div><div class="jp-particle p4"></div><div class="jp-particle p5"></div><div class="absolute inset-0 z-10">${this.nodes()}</div></div></div>`;
  },
