  ...
  _forecastRealizadoBlock(product) {
    ...
    if (f.meta <= 0) {
      return `<div class="mb-5 rounded-3xl bg-amber-50 border-2 border-amber-200 border-l-8 border-l-amber-500 p-5">
        ...
        <button onclick="Actions.openProductOffers(${product.id})" class="mt-3 px-4 py-2 rounded-2xl bg-amber-700 hover:bg-amber-800 text-white font-black text-sm" style="color:#fff!important;">Definir meta nas ofertas →</button>
      </div>`;
    }
