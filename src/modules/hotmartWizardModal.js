    ...
    _step2(w, status) {
      ...
      return `<div class="space-y-4">
        ${alreadyConfigured ? `<div class="rounded-xl bg-emerald-500/10 border border-emerald-400/40 p-3">
          ...
          <p class="text-[12px] text-emerald-100">HOTTOK atual: <span class="font-mono">${Utils.escape(status.hottokMasked || '—')}</span></p>
          <p class="text-[10px] text-emerald-100/70 mt-1">Cole um novo HOTTOK abaixo se quiser substituir.</p>
        </div>` : ''}
        ...
        <div class="space-y-1.5">
          <label class="text-[11px] font-black text-orange-300 uppercase tracking-widest">HOTTOK do produto</label>
          ...
          <p class="text-[10px] text-slate-500">É um identificador alfanumérico longo. Fica criptografado no nosso banco.</p>
        </div>
      ...
      return `<div class="space-y-4">
        ...
        <div class="rounded-2xl bg-slate-800/40 border border-white/10 p-4 space-y-2">
          ...
          <ol class="space-y-1.5 text-[12px] text-slate-300 list-decimal pl-5">
            ...
            <li>Selecione os eventos: <b>PURCHASE_APPROVED</b>, <b>PURCHASE_COMPLETE</b>, <b>PURCHASE_REFUNDED</b>, <b>PURCHASE_CHARGEBACK</b>, <b>PURCHASE_CANCELED</b>.</li>
