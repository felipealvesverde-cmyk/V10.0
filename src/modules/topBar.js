...
window.TopBar = {
  render() {
    ...
    return `<div class="lj-topbar fixed top-3 right-4 z-30 flex items-center gap-2 px-2 py-1.5 rounded-2xl bg-slate-900/90 backdrop-blur-sm border border-slate-700 shadow-lg">
