...
var App = {
      ...
      render() {
        ...
        app.innerHTML = (screens[this.state.activeTab]?.render() || (window.HomeModule ? HomeModule.render() : ProductsModule.render())) + (window.SettingsModal ? SettingsModal.render() : '') + (window.CreateClickupTaskModal ? CreateClickupTaskModal.render() : '') + (window.ConnectActionWizardModal ? ConnectActionWizardModal.render() : '') + (window.ReloginInlineModal ? ReloginInlineModal.render() : '') + (window.TrackerWizardModal ? TrackerWizardModal.render() : '') + (window.TrackerVisitorDetailModal ? TrackerVisitorDetailModal.render() : '') + (window.HotmartWizardModal ? HotmartWizardModal.render() : '') + (window.ReconciliationModal ? ReconciliationModal.render() : '') + (window.TriggersModal ? TriggersModal.render() : '') + (window.ScoreConfigModal ? ScoreConfigModal.render() : '') + (window.ScoreBreakdownModal ? ScoreBreakdownModal.render() : '') + (window.SubStageFunnelModal ? SubStageFunnelModal.render() : '') + (window.ConfirmModal ? ConfirmModal.render() : '') + (window.LeadImportWizard ? LeadImportWizard.render() : '') + (window.SessionExpiredBanner ? SessionExpiredBanner.render() : '') + (window.GoogleAdsWizardModal ? GoogleAdsWizardModal.render() : '') + (window.Ga4WizardModal ? Ga4WizardModal.render() : '') + (window.RdConnectionModal ? RdConnectionModal.render() : '') + (window.ClickupConnectionModal ? ClickupConnectionModal.render() : '') + (window.IntegrationDeepDiveModal ? IntegrationDeepDiveModal.render() : '') + (window.AdsAssociationWizard ? AdsAssociationWizard.render() : '') + (window.GoogleAdsAdvancedModal ? GoogleAdsAdvancedModal.render() : '') + (window.KpiHelpModal ? KpiHelpModal.render() : '') + (window.RdWebhookLogModal ? RdWebhookLogModal.render() : '');
